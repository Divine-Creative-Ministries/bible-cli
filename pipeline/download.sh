...
#
# Deliberately NOT used (licensing review): STEPBible TBESH (requires Online
# Bible permission), Berean bsb_tables.tsv (embedded source-edition columns of
# unclear status), TFLSJ (billmounce.com-sourced entries), CC BY-SA corpora.
set -euo pipefail
cd "$(dirname "$0")/.."
mkdir -p .cache/raw/{ebible,berean,stepbible,dodson,openbible,bdb,lxx}
cd .cache/raw

# Pinned upstream commits for reproducible builds.
STEP_COMMIT="b86d26cdb1f51729e73b5b4eb7f7ccadc5dfba39"
BDB_COMMIT="5a7a632d6923641c4a71dbf23df719711e3d2041"
LXX_COMMIT="26bad3eb42bba98471d154c954e36a6f30a0279d"
DODSON_COMMIT="master"

SB="https://raw.githubusercontent.com/STEPBible/STEPBible-Data/$STEP_COMMIT"
...
get dodson/dodson.csv "https://raw.githubusercontent.com/biblicalhumanities/Dodson-Greek-Lexicon/$DODSON_COMMIT/dodson.csv" &
get bdb/bdb-enhanced.zip "https://github.com/unfoldingWord/Brown-Driver-Briggs-Enhanced/archive/$BDB_COMMIT.zip" &
get lxx/lxx-swete.zip "https://github.com/nathans/lxx-swete/archive/$LXX_COMMIT.zip" &
wait
...
get stepbible/TIPNR.txt "$SB/Proper%20Nouns/TIPNR%20-%20Translators%20Individualised%20Proper%20Names%20with%20all%20References%20-%20STEPBible.org%20CC%20BY.txt" &
...
ls bdb/Brown-Driver-Briggs-Enhanced-* >/dev/null 2>&1 || (cd bdb && unzip -oq bdb-enhanced.zip)
ls lxx/lxx-swete-* >/dev/null 2>&1 || (cd lxx && unzip -oq lxx-swete.zip)
