...
Dodson Greek-English Lexicon
  ...
  Public Domain Greek-English lexicon of the New Testament by John Jeffrey Dodson (CC0).

American Standard Version (1901)
  https://ebible.org/find/show.php?id=eng-asv
  license: Public Domain
  American Standard Version (1901), public domain.

King James Version (KJV, 1769 text)
  https://ebible.org/find/show.php?id=eng-kjv2006
  license: Public Domain
  King James Version, public domain in most of the world (Crown patent applies within the UK).
...
STEPBible TAGNT — Translators Amalgamated Greek NT
  ...
  license: CC BY 4.0
  TAGNT data created by www.STEPBible.org based on work at Tyndale House Cambridge (CC BY 4.0). Source: github.com/STEPBible/STEPBible-Data.

STEPBible TAHOT — Translators Amalgamated Hebrew OT
  https://github.com/STEPBible/STEPBible-Data
  license: CC BY 4.0
  TAHOT data created by www.STEPBible.org based on work at Tyndale House Cambridge (CC BY 4.0). Source: github.com/STEPBible/STEPBible-Data.

STEPBible TBESG — Brief Greek Lexicon (extended Abbott-Smith)
  https://github.com/STEPBible/STEPBible-Data
  license: CC BY 4.0
