...
for f in bible-core.db bible-study.db bible-lxx.db bible-syntax.db; do
...
for (const f of ["bible-core.db.gz","bible-study.db.gz","bible-lxx.db.gz","bible-syntax.db.gz"]) {
